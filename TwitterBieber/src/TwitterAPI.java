...
public class TwitterAPI {
    ...
    public String getUsesTimeLine()
        ...
        // TwitterAPI URL
        String sUrl = "https://api.twitter.com/1.1/search/tweets.json";
        String sMethod = "GET";
    ...
    private Map<String, String> getUserTimeLineParamMap() {
        ...
        // 検索文字列
        urlParamMap.put("q", "JustinBieber");
        // 取得件数設定
        urlParamMap.put("count", "100");
        // リツイートは除く
        urlParamMap.put("exclude", "retweets");
        // イメージがあるツイートだけ取得
        urlParamMap.put("filter", "images");
